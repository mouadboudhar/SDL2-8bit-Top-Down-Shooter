...
int main(int argc, char *argv[])
{
    ...
    SDL_Texture *spriteSheetTexture = loadTexture("Sprites/spritesheet3.png", renderer);
    ...
    SDL_Texture *uiTextures = loadTexture("Sprites/hpbar.png", renderer);
    if (uiTextures == NULL)
    {
    ...
    SDL_Texture *avatarTexture = loadTexture("Sprites/MageAvatar2framed.png", renderer);
    ...
    SDL_Texture *hpPotTexture = loadTexture("Sprites/game_assets/sprite.png", renderer);
    if (avatarTexture == NULL)
    {
    ...
    SDL_Texture *projectileSpriteSheet = loadTexture("Sprites/projectileSpriteSheet.png", renderer);
    ...
    const char *fontPath = "fonts/AncientModernTales-a7Po.ttf";
    ...
    tmx_map *map = mapLoader("maps/2/dungeonRoom1.tmx");
    ...
    // Create items
    initHashTable(table);
    Item *HealthPotion = createConsumable("Health Potion", loadTexture("Sprites/game_assets/PACK/sprite.png", renderer), 81, 1, HEALING, player->maxhealth * 20 / 100);
    insertItem(table, HealthPotion);
    Item *ManaPotion = createConsumable("Mana Potion", loadTexture("Sprites/game_assets/PACK/sprite.png", renderer), 97, 1, HEALING, player->health * 20 / 100);
    insertItem(table, ManaPotion);
    Item *StaffPlaceholder = createWeapon("Staff Placeholder", loadTexture("Sprites/game_assets/PACK/sprite.png", renderer), 1, 65, STAFF, 9999, 9999, 9999, 9999, 0);
    insertItem(table, StaffPlaceholder);
    Item *VoidBlade = createWeapon("Void Blade", loadTexture("Sprites/void_blade.png", renderer), 0, 0, SWORD, 9999, 9999, 9999, 9999, 0);
    insertItem(table, VoidBlade);
    printHashTable(table);
    // Iventory Display
    inventoryDisplay invDisplay;
    invDisplay.inventoryTexture = loadTexture("Sprites/inventory_32.png", renderer);
    int rectW, rectH;
