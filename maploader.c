...
{
    SDL_Texture *spritesheet_floor = SDL_tex_loader("maps/test_map/0x72_DungeonTilesetII_v1.7/atlas_floor-16x16.png");
    if (spritesheet_floor == NULL)
        SDL_Log("Failed to load spritesheet_floor: %s", SDL_GetError());

    SDL_Texture *spritesheet_walls_high = SDL_tex_loader("maps/test_map/0x72_DungeonTilesetII_v1.7/atlas_walls_high-16x32.png");
    if (spritesheet_walls_high == NULL)
        SDL_Log("Failed to load spritesheet_walls_low: %s", SDL_GetError());

    SDL_Texture *spritesheet_walls_low = SDL_tex_loader("maps/test_map/0x72_DungeonTilesetII_v1.7/atlas_walls_low-16x16.png");
    if (spritesheet_walls_low == NULL)
        SDL_Log("Failed to load spritesheet_walls_low: %s", SDL_GetError());

    SDL_Texture *spritesheet_dungeon_tileset = SDL_tex_loader("maps/2/tileset.png");
